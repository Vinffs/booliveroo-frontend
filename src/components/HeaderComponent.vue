        ...
        <div
          ...
          <div class="navbar-nav">
            <ul class="d-flex list-unstyled justify-content-center align-items-center">
                ...
                <li class="nav-item">
                    <router-link class="nav-link  fs-5" to="/" :class="{ active: currentRoute === '/' }">
                        <span>Home</span>
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link  fs-5" to="/search" :class="{ active: currentRoute === '/search' }">
                      <span>Cerca</span>
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link  fs-5" to="/" :class="{ active: currentRoute === '/prova4' }">
                      <span>prova</span>
                    </router-link>
                </li>
            </ul>
    ...
    <div class="container-fluid">
      <nav class="row justify-content-between align-items-center">
        ...
        <div class="col text-end d-flex justify-content-end position-relative">
          ...
          <div class="d-flex align-items-center darkmode" @click="store.darkMode = !store.darkMode">
