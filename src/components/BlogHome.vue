<template>
  <div class="blog">
    <h2
      class="text-center fw-semibold m-0 pt-5"
    ...
    <div class="pt-5 pb-5 container">
      <div class="row justify-content-center align-items-center">
        <div
          class="card rounded my-card col-12 col-md-6 col-lg-4"
          :class="store.darkMode ? 'dark-secondary' : 'light-secondary'"
        >
          <a
            class="card-content text-decoration-none"
            href="https://ricette.giallozafferano.it/Spaghetti-alla-Carbonara.html"
            target="”_blank”"
          >
            <div
              class="card-image spaghetti"
              :class="store.darkMode ? 'image-dark' : 'image-light'"
            >
            ...
            <div
              ...
              :class="
                ...
                store.darkMode ? 'text-light' : 'text-dark')
              "
            >
              <h5 class="card-title fw-semibold">Spaghetti alla Carbonara</h5>
              <p class="card-text">
                <span class="fw-semibold">Da: </span>Giallo Zafferano
              </p>
              <span class="user d-flex">
                <img
                  class="me-1"
                  src="/images/blog/mirko.png"
                  alt="user-profile"
                />
        ...
        >
          <a
            class="card-content text-decoration-none"
            href="https://ricette.giallozafferano.it/Risotto-ai-mirtilli-di-bosco-e-erba-cipollina.html"
            target="”_blank”"
          >
            <div
              class="card-image risotto"
              :class="store.darkMode ? 'image-dark' : 'image-light'"
            >
        ...
        >
          <a
            class="card-content text-decoration-none"
            href="https://ricette.giallozafferano.it/Tortellini-in-brodo.html"
            target="”_blank”"
          >
            <div
              class="card-image tortellini"
              :class="store.darkMode ? 'image-dark' : 'image-light'"
            >
